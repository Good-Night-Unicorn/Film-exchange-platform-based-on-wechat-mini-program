	...
	<view class="content my-publish-pv">
		<form>
			<view class="cu-form-group">
				...
				<input :style='{"padding":"8rpx 20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"8rpx 0","borderColor":"rgba(147, 129, 142, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"8rpx 2rpx 2rpx","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' disabled="true" v-model="ruleForm.username" placeholder="留言人用户名"></input>
			</view>
			<view class="cu-form-group">
				<!-- <view :style="userInfoForm.list.title" class="title">留言内容</view> -->
				<textarea :style='{"padding":"20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"rgba(147, 129, 142, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","borderRadius":"0","borderWidth":"8rpx 2rpx 2rpx","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"260rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","margin":"20rpx auto","borderColor":"#409EFF","backgroundColor":"rgba(147, 129, 142, 1)","color":"#fff","borderRadius":"0","borderWidth":"0","width":"60%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
...
<style lang="scss" scoped>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20220218/e625f6dc628c43fbbad062414c3fb34f.png);
